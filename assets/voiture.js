(() => {
    ...
    const sliderprice = document.getElementById("prix-slider");
    if (sliderprice) {
  ...
  const sliderYear = document.getElementById("annee-slider");
  if (sliderYear) {
      const yearmin = document.getElementById("anneemin");
      const yearmax = document.getElementById("anneemax");

 ...
 */
final class Version20230630153601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD voiture_id INT DEFAULT NULL, CHANGE message message VARCHAR(1000) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP voiture_id, CHANGE message message VARCHAR(255) NOT NULL');
    }
}
